...
export const fetchAllAssets = createAsyncThunk(
  ...
  async (userId: number, thunkApi) => {
    ...
    axios
      .get<Root>(
        'https://catalog-service-cdn.api.aha.firstlight.ai/catalog/storefront/2E553D81-94BB-4B9D-8F62-C77CFA74DCEB/F9F04572-D201-4FDC-813F-ECA88DB83CE7/containers?pageNumber=1&pageSize=5&policy_evaluate=false&reg=ca&acl=ta&dt=androidtv',
      )
